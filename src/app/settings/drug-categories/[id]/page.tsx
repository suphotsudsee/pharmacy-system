...
export default function EditDrugCategoryPage() {
  ...
  const fetchCategory = async () => {
    try {
      setLoading(true);
      const res = await fetch(`/api/drug-categories/${params.id}`);
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6 dark:text-white">✏️ แก้ไขหมวดยา</h1>
